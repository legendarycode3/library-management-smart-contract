...
2. ****Transparency & Trust:**** Every action performed in the smart contract is publicly verifiable. Because blockchain data is immutable, users can trust that records
